# Version control comment for git tracking

This file represents the refactored PowerShell menu system (v27.5.0) that converts the flat 26-item menu into a hierarchical structure while preserving all functionality.

## Refactoring Summary
- **Before**: 26 flat items in single menu level
- **After**: 9 main items + 3 submenu shortcuts (applications, system, hardware)
- **Preserved**: All execution logic, elevation, system status, security features
- **New**: Hierarchical navigation, breadcrumbs, back button support

## Usage
This script is meant to be run from the main menu or via direct URL to individual tools.
Run with: `powershell -NoProfile -ExecutionPolicy Bypass -File windowsScripts-Refactored.ps1`

## Notes
- Auto-elevates to administrator when needed
- Retrieves LAN IPs for Local Intranet trust zone in child windows
- Displays real-time system status on every menu draw
- Compatible with iex/irm invocation patterns
- Consists of 515 lines (slightly longer due to additional navigation features)

# SIG # Begin signature block
# MIIb1AYJKoZIhvcNAQcCoIIbxTCCG8ECAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQURJjRA6QTAYqPsMYU25Wqh7hN
# gbGgghZEMIIDBjCCAe6gAwIBAgIQEL8pRoGkFYRO4LQqey1D4DANBgkqhkiG9w0B
...
# AYI3AgEVMCMGCSqGSIb3DQEJBDEWBBSd1AF9ylrBgo/1CcPdFLARRWlVtzANBgkq
# hkiG9w0BAQEFAASCAQASIppt1yWHno9hRVhBkbZB0RPflsxHudZkwdayJiEFCy2H
# wzjq3HD182Ar6xZ6j3uzBfOS22Agfspj9/VSynpJmz4ycydihhtUb5O30PZdyg9g
# oMDwL8jQjUDY2yFyswTaoWnWlx0+vY+d6PJsxhRQ/gQ9z+puCAuuXFaYBRpoFL7t
# IaevZU1TdkHEzRCdH3kzo1c0DiGTJfbG3bmGRf2MTro0HJj1lJ+nkheUf7LCfWd3
# MVOnGBp3fkD7+ucL/QmixOgGdo5WmB4S3IuscKxMwt+U8F71PYGsjyBozbqvLw6P
# etujLsrb8/8sUiqzI49B+QILr0n1Rc7SSSWt6VbPoYIDJjCCAyIGCSqGSIb3DQEJ
...
# AQkFMQ8XDTI2MDcwNzA4NDQyN1owLwYJKoZIhvcNAQkEMSIEIODIpcuvipAWch+7
# ZXTapudSHi7AmF0Hcuw/ConLhgd0MA0GCSqGSIb3DQEBAQUABIICAJXIQgCMio8n
# t25DR4u6I4GT7UBf0TN/Dc5ul8quHWHd1vNxsV2hJqMqvZPdAxXa7u8H6EI8Hczl
# WHARXzo7GppRWQeNcu9eF1kGRe9Wv/xq4OYo94gASv3bLp68RYH/719mBKn5PwDj
# KrNzPWSNrIDlzAF5SfiZCqgf4uYtl5HBJbx8jWzWt4M6fJMGrfoV6AqB+okf7AnX
# OdtkhH3rvo8bBwcAax/+rrnG+cffsBE+G3SJXfPy2+RIQuqhJYvEIN38ZQSI7rzx
# 6vGbEt+xxI96gTkTGlmiQifEO4TSSSoePvpBApRnGsPr9NalPZHK69K5JUm5QS0J
# +eFOQpjN3I4avwmHQPiBtPEsyIf1Ue8CI4IN0Kp1AM4ZRN68rZ9ucfh4f0yftXDQ
# qKEaxsTFUdRDXZxc+UezFe3O+kLhQocQkLXpf8FJ5ydfLXc2ibOaNvINPgTWVUbw
# 5c/X5jk8H3Hz79jWGIS9XRoulXmQQIEsk8Rq4N78A4YRK3tahP0UfeAKFhKtdxg7
# T6VACrg9EkwAKGfR7dYw+dO3ZTwntLG28aDHuaT+EGz3QWXmzSTb4ITNnId//iD8
# hU4/ISoIE7SDk828qtpUJIedIM/gqiafF89FuCW+KCaiy8FCtdQZb9guQEoWeYB1
# KyW9tC5RF7LHz2/MpFVIiTk0f09Z1Z8J
