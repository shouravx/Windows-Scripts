...
& {
    ...
    # --- Download Component ---
    Write-Progress -Activity "Downloading MediCat Installer..." -Status "Connecting to GitHub"
    try {
        if ($psv -ge 3) {
        ...
        Write-Host "Failed to retrieve script: $($_.Exception.Message)" -ForegroundColor Red
        return
    }
    ...
    $FilePath = if ($isAdmin) {
        "$env:SystemRoot\Temp\MediCat_$rand.bat"
    } else {
        "$env:USERPROFILE\AppData\Local\Temp\MediCat_$rand.bat"
    }

    # --- Save and Execute ---
    try {
        $response | Out-File $FilePath -Encoding ASCII -Force
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUFrsbClqg8qvoaK9aZwP/pUkP
# vN+gghZEMIIDBjCCAe6gAwIBAgIQEL8pRoGkFYRO4LQqey1D4DANBgkqhkiG9w0B
...
# AYI3AgEVMCMGCSqGSIb3DQEJBDEWBBSoVCKFUeSc84FnuCbj3yzlgseTrTANBgkq
# hkiG9w0BAQEFAASCAQCW8r7iIBqrx0mTOZyxuvZyXlHxYHCoFHKgbhSycgLf5t8M
# F3rLdPL7b+Pboj39Hgom1DC5hLPiuxZ7JdhqbT0DX7qr3U7VeHpUz9oR3ZfBLRbW
# IEQ+tALDUdjhpapDy8nEvKkd4EjzdJZsfqbfa3xBqqaKw9uSn0NCmUKH9JxZOSxQ
# 2IHSbv3gE8/Na8k5PrcU9sVVlI9ULUcY6BXeORJKs3Q5zvW7RRmpd4bfpwZb+cDr
# kNS4IRgGRCRT3X0M5M1TDdsHqE34rM6NFoePbY4le4FAYmhnxLAVlh5guGAZI5/P
# BjHUsfQcC87jz9VtvPKuDRJUzgjkK+eotHQGaQLfoYIDJjCCAyIGCSqGSIb3DQEJ
...
# AQkFMQ8XDTI2MDcwNzA4NDQ0NlowLwYJKoZIhvcNAQkEMSIEID4DF7U7dho1+iuK
# bHAbLxjigeGxOBWID0R1J5jUrefWMA0GCSqGSIb3DQEBAQUABIICAGywa1Eofg7E
# jYCYXOg9SF5jMDQmZKguD4e3Qz2/du6V5ti6R00GJbYCzHWybwouVLAbLHjyx2m2
# 7kpFi/OchVFc5L2A5ivmWQr0C+vMKa6PVd3HSa5tKJDvKLT4x500xMG0XAi3F5Lw
# EssUdWxq1r5Aef23WZHQwc7h1zRRvf1FWt2C19JnIBRw+Now97ehl2/NLIsokzWy
# cBA20vQ4i9JScXmQnb9PzhIwYx2YmzgnH/LeR6y33vJQXpt4JG1zz4AaJ+vCRa1Z
# 5htm1OGbdld7Kl36swCZbMPLefi6qqWdnEFUChWxsWvmcC2nfEBi9DbcjS5cpUS5
# Y902SAs1Kptdnp4VdMfVB4ES76B3T2mdgRuJtST/QihM275Y0Nc5mx+zVDN/QeS0
# 5ZlVuGnHwZu4uYpc3pb+4SyrtA6h0iUdDjexMzKRUnOGgDyjYtR/TouMVrxhA316
# 2wPQZvFW/Qzl8rZy3fRT7hk9CDpAu4IJ4h/EA+6lhhFuRQ1flNwpiJPrAsmjj484
# GVo7KZqqXjWyAlFBu9xnRDFvMR9mFUqTF+4xXtVCWuLleyrehqpveNhE4WQ09oZ3
# y7GfZ6ZqH9oCHoav0d13O63uWPKDpOujca98tJX/g7l0mXUxjRFJecU86qVSEoqc
# p1qALKSXJDKWy4BITe7C3eR8N6Z8hcce
