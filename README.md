...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -Command "iex (irm 'https://raw.githubusercontent.com/shouravx/Windows-Scripts/refs/heads/main/windowsScripts.ps1')"
```
